...
function AboutCovid19() {
    ...
    const toggle1 = () => { setPart1(!part1);}
    const toggle2 = () => { setPart2(!part2);}
    const toggle3 = () => { setPart3(!part3);}

    return (
        <div className="AboutMain">
            
            <img className="title" src={require("./images/image.png")} alt="title"/> {/* COVID-19 image*/}
            ...
            <div className="animation">
                ...
                <p style={{textAlign: "center"}}>
                    ...
                    <img
                        ...
                        alt=""
                    /> 
                    by maintaining at least <span style={{color: "red", fontWeight: "400", fontSize: "30px"}}> 6 feet </span> 
                    between you and others.
                </p>
            
                <div className="icons">
                    <span className="advice"><h3>Avoid physical contact</h3></span>
                    <span className="advice"><h3>Wash your hands</h3></span>
                    <span className="advice"><h3>Wear mask</h3></span>
                </div>
            </div>
            ...
            {part1 &&
                <div>
                    <p>On February 11, 2020, the World Health Organization announced an official name for the disease that is causing the 2019 
                        novel coronavirus outbreak, first identified in Wuhan, China. 
                        <b>The new name of this disease is coronavirus disease 2019, abbreviated as COVID-19.</b> 
                        In COVID-19, ‘CO’ stands for ‘corona,’ ‘VI’ for ‘virus,’ and ‘D’ for disease. Formerly, 
            ...
            {part2 &&
                <div>
                    <p>COVID-19 is caused by a coronavirus called <b>SARS-CoV-2</b>. Coronaviruses are a large family of viruses 
                    that are common in people and many different species of animals, including camels, cattle, cats, and bats.  
                    Rarely, animal coronaviruses can infect people and then spread between people. 
                    This occurred with MERS-CoV and SARS-CoV, and now with the virus that causes COVID-19. 
                    The SARS-CoV-2 virus is a betacoronavirus, like MERS-CoV and SARS-CoV. All three of these viruses have their origins 
                    in bats. The sequences from U.S. patients are similar to the one that China initially posted, 
                    suggesting a likely single, recent emergence of this virus from an animal reservoir. 
                    However, the exact source of this virus is unknown.</p>
                </div>     
            }
                ...
                <div className="part3">
                    <div className="move-right">
                        <p>People with COVID-19 have had a wide range of symptoms reported – ranging from mild symptoms to severe illness. 
                            Symptoms may appear 2-14 days after exposure to the virus. People with these symptoms may have COVID-19:</p>
